...
Future<File> _createLevelFile(String name, String extension) async {
  Directory? appDocDir = await getApplicationDocumentsDirectory();
  String appDocPath = appDocDir.path;
  File file = File('$appDocPath/$name.$extension');
  print(await file.create());
...
void buildBarcode(
  ...
  _createLevelFile(filename, 'svg');
  // File('$filename.svg').writeAsStringSync(svg);
  //File('$filename.svg').create(recursive: true);
}
